...
const posts = [
  ...
  { slug: 'week26-yong-AI-zuo-shu-xue-lun-wen-zong-shu-gong-ju-ping-ce', title: '用AI做数学论文综述工具评测：从文献检索到写作全流程', desc: '深度评测Connected Papers、ResearchRabbit、Scholarcy、Elicit等主流AI工具在数学论文综述中的应用效果，给出从文献检索到写作的全流程实操指南。' },
]
