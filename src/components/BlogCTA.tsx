  ...
  return (
    <div className="mt-10 pt-8 border-t border-border">
      <div className="p-6 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl border border-primary/20 text-center">
        <p className="text-lg font-bold text-text mb-1">📄 Summarize Papers with AI</p>
        <p className="text-text-secondary text-sm mb-5">Free to use — 3 summaries per day, unlimited for Pro users</p>
