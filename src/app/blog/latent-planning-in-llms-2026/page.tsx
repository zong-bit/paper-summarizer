...
export const metadata = {
  title: 'AI模型会"提前计划"吗？隐性计划机制解读 | Paper Summarizer',
  description: '2026年5月最新论文揭示：大语言模型在生成文本时会在内部"提前计划"未来输出，但只有Gemma-3-27B真正使用这个计划。深度解读这一发现对AI论文摘要工具的启示。',
  keywords: ['隐性计划', 'latent planning', '大模型', '机制可解释性', '激活修补', 'Gemma-3', 'Qwen3', 'Llama-3', 'AI论文摘要', '论文摘要工具', 'mechanistic interpretability', 'activation patching', '线性探针', 'AI安全', 'paper-summarizer'],
  openGraph: {
    title: 'AI模型会"提前计划"吗？2026年最新研究揭示大模型的"思维路线图"',
    description: '2026年5月最新论文揭示：大语言模型在生成文本时会在内部"提前计划"未来输出，但只有Gemma-3-27B真正使用这个计划。深度解读这一发现对AI论文摘要工具的启示。',
    type: 'article',
  },
}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 pt-4 border-t border-border/50">
          <ShareButton title='AI模型会「提前计划」吗？隐性计划机制解读 - Paper Summarizer' compact />
        </div>
