        ...
        <section className="bg-slate-950 py-16 md:py-20">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Card 1 */}
              <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-5 text-center hover:border-blue-500/30 transition-colors group">
              ...
              {/* Card 2 */}
              <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-5 text-center hover:border-indigo-500/30 transition-colors group">
              ...
              {/* Card 3 */}
              <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-5 text-center hover:border-violet-500/30 transition-colors group">
