  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1">
        ...
        {/* ===== FAQ Section (for AdSense content) ===== */}
        <section className="bg-slate-900/30 py-16">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-3">
              <FaqItem
                question="How does Paper Summarizer work?"
                answer={
                  <ol className="list-decimal list-inside space-y-2">
                    <li><strong>Upload or paste</strong> your research paper — support PDF upload, arXiv URL, or direct text paste.</li>
                    <li><strong>Select a domain</strong> (General, Computer Science, Biology, or Medicine) to optimize the summary for your field.</li>
                    <li><strong>Our AI processes</strong> the content using large language models, extracting the research question, methodology, key findings, and conclusions.</li>
                    <li><strong>A structured summary</strong> is generated with clear sections, making it easy to quickly grasp the paper's contributions.</li>
                    <li><strong>Export or share</strong> your summary in multiple formats, or dive deeper with our Paper Q&A and Comparison tools.</li>
                  </ol>
                }
              />
              <FaqItem
                question="What types of papers can it summarize?"
                answer="Paper Summarizer works with most academic papers across all disciplines — including Computer Science, Biology, Medicine, Engineering, Physics, Social Sciences, and Humanities. It handles peer-reviewed journal articles, conference papers, preprints (arXiv, bioRxiv), dissertations, technical reports, and book chapters. The system performs best with well-structured papers that have clear sections like Introduction, Methodology, Results, and Discussion."
              />
              <FaqItem
                question="How accurate is the summary?"
                answer="Our summaries are generated by advanced large language models fine-tuned for academic content. The accuracy depends on the quality of the input text and the complexity of the paper. We structure summaries to make source-tracing easy — each section (key findings, methodology, etc.) is clearly separated so you can quickly verify claims against the original paper. For complex mathematical proofs or highly specialized jargon, we recommend cross-referencing with the original text. Pro users can also use our Paper Q&A feature to ask targeted questions about specific sections."
              />
              <FaqItem
                question="Is it free?"
                answer="Yes! Paper Summarizer offers a generous free tier: every visitor gets 3 free summaries per day without any login required. You can upload PDFs, paste text, or use arXiv URLs. The free tier covers all standard academic paper domains. For researchers who need more, our Pro plan removes all limits and adds advanced features like Paper Q&A, Paper Comparison, and Literature Outline generation."
              />
              <FaqItem
                question="What is the difference between Free and Pro?"
                answer="The Free plan gives you 3 summaries per day with structured output and citation export. The Pro plan ($9.99/month or $99.99/year) unlocks unlimited summaries, priority processing (faster results), unlimited PDF uploads, Paper Q&A (chat with your paper), Paper Comparison (side-by-side analysis), Literature Outline generation, and priority email support. Pro tokens can also be used across all our tools."
              />
              <FaqItem
                question="Can I upload PDF files?"
                answer="Yes. You can upload PDF files directly on the homepage. Our system uses a specialized PDF extraction pipeline designed for academic papers, handling multi-column layouts, mathematical formulas, tables, and embedded figures. The extracted text is then processed by our AI summarization engine. Free users get 3 PDF uploads per day; Pro users have unlimited uploads."
              />
              <FaqItem
                question="Is my data private and secure?"
                answer="Absolutely. We take data privacy seriously. Paper text you upload is processed by our AI APIs for summarization and is not stored longer than necessary. We do not train models on user data. Your personal information (email, payment details) is handled securely — payment processing is done through Paddle and Gumroad, and we never see your full payment details. See our Privacy Policy for more information."
              />
            </div>
          </div>
        </section>
...
function FaqItem({ question, answer }: { question: string; answer: React.ReactNode }) {
  return (
    <details className="group bg-slate-800/40 border border-slate-700/40 rounded-xl overflow-hidden">
